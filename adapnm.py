...
class AdaPNM(Optimizer):
    r"""Implements Adam with Positive-Negative Momentum.
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                p.addcdiv_(exp_avg.mul(1-beta3/2.).add(neg_exp_avg,alpha=beta3/2.), denom, value=-step_size)
        return loss